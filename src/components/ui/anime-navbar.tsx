...
export function AnimeNavBar({ items, className, defaultActive = "Home", logo, rightContent }: NavBarProps) {
  ...
  return (
    <div className={cn("fixed top-5 left-0 right-0 z-[9999] px-4 md:px-8 pointer-events-none", className)}>
      <div className="flex items-center justify-between pt-6 max-w-7xl mx-auto pointer-events-auto">
        {/* Logo Section */}
